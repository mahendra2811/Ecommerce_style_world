          ...
          <div className="row g-4 justify-content-center row-cols-1 row-cols-md-2 row-cols-xl-3 align-items-center">
            ...
            <div className="col">
              <div className="instructor-content">
                ...
                <p>{desc}</p>
                <Link to="/contact" target="blank" className="lab-btn">
                  <span>{btnText}</span>
                </Link>
              </div>
            </div>
